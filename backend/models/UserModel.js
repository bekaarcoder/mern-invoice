...
const userSchema = new Schema(
    {
        ...
        firstName: {
            ...
            validate: [
                ...
                'First name can only be Alphanumeric values. No special characters allowed',
            ],
        },
        lastName: {
            type: String,
            ...
            validate: [
                validator.isAlphanumeric,
                'Last name can only be Alphanumeric values. No special characters allowed',
            ],
        },
        password: {
            type: String,
        ...
        phoneNumber: {
            type: String,
            default: '+919009001010',
            validate: [
                validator.isMobilePhone,
                "Your mobile number must begin with a '+', followed by your country code and then the actual number",
            ],
        },
        address: String,
        city: String,
